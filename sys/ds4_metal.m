...
static NSString *ds4_gpu_full_source(void) {
    ...
    NSArray<NSArray<NSString *> *> *required_sources = @[
        @[@"DS4_METAL_FLASH_ATTN_SOURCE", @"sys/metal/flash_attn.metal"],
        @[@"DS4_METAL_DENSE_SOURCE",      @"sys/metal/dense.metal"],
        @[@"DS4_METAL_MOE_SOURCE",        @"sys/metal/moe.metal"],
        @[@"DS4_METAL_DSV4_HC_SOURCE",    @"sys/metal/dsv4_hc.metal"],
        @[@"DS4_METAL_UNARY_SOURCE",      @"sys/metal/unary.metal"],
        @[@"DS4_METAL_DSV4_KV_SOURCE",    @"sys/metal/dsv4_kv.metal"],
        @[@"DS4_METAL_DSV4_ROPE_SOURCE",  @"sys/metal/dsv4_rope.metal"],
        @[@"DS4_METAL_DSV4_MISC_SOURCE",  @"sys/metal/dsv4_misc.metal"],
        @[@"DS4_METAL_ARGSORT_SOURCE",    @"sys/metal/argsort.metal"],
        @[@"DS4_METAL_CPY_SOURCE",        @"sys/metal/cpy.metal"],
        @[@"DS4_METAL_CONCAT_SOURCE",     @"sys/metal/concat.metal"],
        @[@"DS4_METAL_GET_ROWS_SOURCE",   @"sys/metal/get_rows.metal"],
        @[@"DS4_METAL_SUM_ROWS_SOURCE",   @"sys/metal/sum_rows.metal"],
        @[@"DS4_METAL_SOFTMAX_SOURCE",    @"sys/metal/softmax.metal"],
        @[@"DS4_METAL_REPEAT_SOURCE",     @"sys/metal/repeat.metal"],
        @[@"DS4_METAL_GLU_SOURCE",        @"sys/metal/glu.metal"],
        @[@"DS4_METAL_NORM_SOURCE",       @"sys/metal/norm.metal"],
        @[@"DS4_METAL_BIN_SOURCE",        @"sys/metal/bin.metal"],
        @[@"DS4_METAL_SET_ROWS_SOURCE",   @"sys/metal/set_rows.metal"],
    ];
